...
Site estático em HTML, CSS e JavaScript. Para executar, instale Node.js 18 ou superior, abra o terminal na raiz do projeto (um nível acima de docs/, onde está package.json) e rode:
...
Os comandos acima devem ser executados na raiz do projeto. O servidor local fica em `scripts/server.mjs`; o comando `npm start` já aponta para esse caminho.
